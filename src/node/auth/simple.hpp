...
using simple_auth_future  = std::future<std::unique_ptr<svn::simple_auth>>;
...
struct simple_auth_provider {
  ...
  private:
    ...
    using invoke_function       = std::function<simple_auth_future(simple_auth_provider*, const std::string&, const std::string&, bool)>;
    using invoke_function_async = uv::async<invoke_function, simple_auth_future, simple_auth_provider*, const std::string&, const std::string&, bool>;
